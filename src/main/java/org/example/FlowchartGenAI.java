...
public class FlowchartGenAI {
    ...
    public static final String generateTableOfVariables = "У тебе є код на C.\n" +
            ...
            "9. Записувати 1 змінну треба тільки 1 раз, не більше, не меньше. Зписувати треба тільки її створення/ініціалізацію";
